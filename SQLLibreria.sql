...
--ESTABLECE EL FORMATO DE LA FECHA COMO DÍA/MES/AÑO
SET DATEFORMAT dmy
go
...
--ARTICULOS
insert into articulos (descripcion, stock_minimo, pre_unitario, observaciones) values ('Lápiz Evolution HB2 * 4 u',null, 150.00, null);--1
insert into articulos (descripcion, stock_minimo, pre_unitario, observaciones) values ('Papel p/forrar Fantasía * 10 u',130,500.00, null);
insert into articulos (descripcion, stock_minimo, pre_unitario, observaciones) values ('Papel p/forrar Araña * 10 u',150,600.00, 'Color rojo - azul - verde');
insert into articulos (descripcion, stock_minimo, pre_unitario, observaciones) values ('Lápices Color cortos  * 12 u',54,120.50,null);--4
insert into articulos (descripcion, stock_minimo, pre_unitario, observaciones) values ('Fibras cortas * 6',40, 125.30, null);
insert into articulos (descripcion, stock_minimo, pre_unitario, observaciones) values ('Lápices Color largos * 12 u',null,127.90, null);--6
insert into articulos (descripcion, stock_minimo, pre_unitario, observaciones) values ('Separadores tamaño rivadavia * 6 u',null, 85.70, 'Motivos de Disney');
insert into articulos (descripcion, stock_minimo, pre_unitario, observaciones) values ('Carpeta fibra negra - Tamaño rivadavia',null, 202.90, '3 anillos');--8
insert into articulos (descripcion, stock_minimo, pre_unitario, observaciones) values ('Carpeta Fantasía - Tamaño Rivadavia',60, 250.90, '3 anillos');
insert into articulos (descripcion, stock_minimo, pre_unitario, observaciones) values ('Adhesivo sintético 30 gr',NULL, 36.00, null);--10

insert into articulos (descripcion, stock_minimo, pre_unitario, observaciones) values ('Cuaderno rayado tapa dura',80, 72.70,null);
insert into articulos (descripcion, stock_minimo, pre_unitario, observaciones) values ('Cuaderno cuadriculado',65, 52.70, null);--12
insert into articulos (descripcion, stock_minimo, pre_unitario, observaciones) values ('Repuesto Gloria 400 hojas',120, 641.00, 'Rayado o cuadriculado');
insert into articulos (descripcion, stock_minimo, pre_unitario, observaciones) values ('Repuesto Exito 288 hojas',90, 641.00, 'Rayado o cuadriculado reforzado');
insert into articulos (descripcion, stock_minimo, pre_unitario, observaciones) values ('Conjunto Geométrico',null, 185.90, 'Regla - escuadra - transportador');--15
insert into articulos (descripcion, stock_minimo, pre_unitario, observaciones) values ('Cartuchera Lata',60, 565.50, '2 pisos');
insert into articulos (descripcion, stock_minimo, pre_unitario, observaciones) values ('Cartuchera de Tela',55, 262.60,null);
insert into articulos (descripcion, stock_minimo, pre_unitario, observaciones) values ('Correctores Bic Lápiz * 1 u',null, 71.40, null);
insert into articulos (descripcion, stock_minimo, pre_unitario, observaciones) values ('Rótulos * 18 u',null, 55.90, null);
insert into articulos (descripcion, stock_minimo, pre_unitario, observaciones) values ('Resma hoja A4',40, 385.00, null);--20

insert into articulos (descripcion, stock_minimo, pre_unitario, observaciones) values ('Portaminas',null, 248.90, null);
insert into articulos (descripcion, stock_minimo, pre_unitario, observaciones) values ('Lápices con goma * 2 u',null, 55.50,null);--22
insert into articulos (descripcion, stock_minimo, pre_unitario, observaciones) values ('Goma para Lápiz * 10 u',null, 87.50, null);
insert into articulos (descripcion, stock_minimo, pre_unitario, observaciones) values ('Goma para lapicera * 10 u',null, 99.50, null);--24
insert into articulos (descripcion, stock_minimo, pre_unitario, observaciones) values ('Lápices Color largos * 12 FABER',null, 178.99, null);
insert into articulos (descripcion, stock_minimo, pre_unitario, observaciones) values ('Lapicera Bic trazo fino',null,44.99, null);
insert into articulos (descripcion, stock_minimo, pre_unitario, observaciones) values ('Cuaderno Gloria 12 hojas rayado',20, 92.99,null);--27
...
insert into facturas (cod_vendedor, cod_cliente, fecha) values(2,1,'06/06/2021');
...
insert into detalle_facturas (nro_factura, cod_articulo, pre_unitario, cantidad) values(515,3,600.00,25);
...
insert into detalle_facturas (nro_factura, cod_articulo, pre_unitario, cantidad) values(517,2,500.00,30);
...
insert into detalle_facturas (nro_factura, cod_articulo, pre_unitario, cantidad) values(522,20,352.00,20);
insert into detalle_facturas (nro_factura, cod_articulo, pre_unitario, cantidad) values(523,13,640.90,10);
...
insert into detalle_facturas (nro_factura, cod_articulo, pre_unitario, cantidad) values(529,5,75.90,15);
...
insert into detalle_facturas (nro_factura, cod_articulo, pre_unitario, cantidad) values(534,3,600.00,25);
...
insert into detalle_facturas (nro_factura, cod_articulo, pre_unitario, cantidad) values(535,12,63.00,15);
...
insert into detalle_facturas (nro_factura, cod_articulo, pre_unitario, cantidad) values(541,10,35.00,25);
insert into detalle_facturas (nro_factura, cod_articulo, pre_unitario, cantidad) values(542,11,80.00,10);
insert into detalle_facturas (nro_factura, cod_articulo, pre_unitario, cantidad) values(543,13,640.90,18);
insert into detalle_facturas (nro_factura, cod_articulo, pre_unitario, cantidad) values(544,13,640.50,15);
insert into detalle_facturas (nro_factura, cod_articulo, pre_unitario, cantidad) values(544,2,500.00,15);
insert into detalle_facturas (nro_factura, cod_articulo, pre_unitario, cantidad) values(545,1,150.00,20);
insert into detalle_facturas (nro_factura, cod_articulo, pre_unitario, cantidad) values(546,4,101.30,13);
insert into detalle_facturas (nro_factura, cod_articulo, pre_unitario, cantidad) values(546,11,75.90,15);
insert into detalle_facturas (nro_factura, cod_articulo, pre_unitario, cantidad) values(546,8,200.00,20);
insert into detalle_facturas (nro_factura, cod_articulo, pre_unitario, cantidad) values(547,13,640.50,15);
insert into detalle_facturas (nro_factura, cod_articulo, pre_unitario, cantidad) values(548,20,385.00,25);
insert into detalle_facturas (nro_factura, cod_articulo, pre_unitario, cantidad) values(549,13,640.90,12);
insert into detalle_facturas (nro_factura, cod_articulo, pre_unitario, cantidad) values(550,13,640.50,20);
insert into detalle_facturas (nro_factura, cod_articulo, pre_unitario, cantidad) values(550,6,30.50,20);
insert into detalle_facturas (nro_factura, cod_articulo, pre_unitario, cantidad) values(550,14,650.30,13);
